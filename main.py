...
scale_a = Scale(interval_type='DAYS', start=today, finish=end, width=1600, scale_ends='pink', y=150, height=50, label_type='dates', date_format='d', font_size='10', text_x=5, min_interval_width=20)
